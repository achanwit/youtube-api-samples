...
//            String actionString = "delete";
            String actionString = "list";
//            String actionString = "upload";
//            String actionString = "download";
...
//                uploadCaption(getVideoId(), getLanguage(), getName(), getCaptionFromUser());
            	  uploadCaption("3_zpvHIOhzY","en", "CaptionTest01.srt", new File("/home/chanwit/Documents/UploadSubtitleYoutube/CaptionTest01.srt"));
                break;
              case LIST:
