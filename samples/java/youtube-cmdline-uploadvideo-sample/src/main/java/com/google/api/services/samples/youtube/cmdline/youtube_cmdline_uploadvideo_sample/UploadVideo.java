...
//      YouTube.Channels.List channelRequest = youtube.channels().list("contentDetailsa");
...
//    	  
//    	  playlistItemRequest.setFields("items(contentDetails/videoId,snippet/title,snippet/publishedAt,snippet/description),nextPageToken,pageInfo");
//    	  
//    	  String nextToken = "";
//    	  
//    	  do {
...
//    	  
//    	  prettyPrinter(playlistItemList.size(), playlistItemList.iterator());
//      }
...
//  private static void prettyPrinter(int size, Iterator<PlaylistItem> iterator) {
//	// TODO Auto-generated method stub
//	  if (!iterator.hasNext()) {
//	      System.out.println(" There aren't any results for your query.");
//	    }
//	  for(int i = 0;i<size; i++) {
//	      PlaylistItem palylistItem = iterator.next();
//	      String playlistId = palylistItem.getId();
//	      System.out.println("Playlist Id: " + playlistId);
//	      System.out.println("palylistItem: "+palylistItem);
//		  
//	  }
//}
